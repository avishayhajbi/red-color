...
$.ajax({
	...
	//url : "http://www.oref.org.il/WarningMessages/alerts.json", //CONVERT(html USING utf8)
	...
	success : function(res) {
		...
		console.log('res',(res));
		//console.log('res',(encodeURI(res.query.results.body.p)));
		//console.log('res', $.parseJSON(decodeURI(res.query.results.body.p)));
		//console.log('res', $.parseJSON(decodeURIComponent(res.query.results.body.p)));
		if (res.data)
